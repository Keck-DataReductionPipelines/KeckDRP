...
PACKAGENAME = metadata.get('package_name', 'kcwipy')
DESCRIPTION = metadata.get('description', 'KCWI DRP')
AUTHOR = metadata.get('author', 'D. Neill, L. Rizzi')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: kcwipy requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
